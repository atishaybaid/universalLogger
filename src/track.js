...
self.TrackJS = self.trackJs = (function (g, l, p) {
    "use awesome";
    var u = function (a, b) {
        this.config = a;
        this.onError = b;
    ...
    q.prototype = {
            ...
            serialize: function (a) {
                ...
                try {
                    d = JSON.stringify(a, function (a, d) {
                        return d === p ? "undefined" : c.isNumber(d) && isNaN(d) ? "NaN" : c.isError(d) ? { name: d.name, message: d.message, stack: d.stack } : c.isElement(d) ? b(d) : d;
                    });
                } catch (f) {
                    d = "";
                    for (var e in a)
        ...
        removeEmpty: function (a) {
            for (var b in a) a.hasOwnProperty(b) && a[b] === p && delete a[b];
        },
    ...
    w.prototype = {
        ...
        report: function () {
            return {
                ...
                dependencies: this.config.current.dependencies ? this.discoverDependencies() : { trackJs: "3.9.2" },
    ...
    z.prototype = {
        ...
        watchFetch: function () {
            ...
            c.patch(g, "fetch", function (f) {
                return function (h, n) {
                    if (n && n.__trackjs__) return f.apply(g, arguments);
                    var k;
                    try {
                        throw Error();
                    } catch (E) {
                    ...
                    var m = h instanceof Request ? h.url : h,
                        p = h instanceof Request ? h.method : (n || {}).method || "GET",
                        m = a.escapeUrl(m),
                        l = f.apply(g, arguments);
                    l.__trackjs_state__ = b.add("n", { type: "fetch", startedOn: c.isoNow(), method: p, url: c.truncate(m, 2e3) });
                    return l
                        .then(function (a) {
            ...
            if (a._trackJs) {
                ...
                b &&
                    ((b.completedOn = this.util.isoNow()),
                        a.getAllResponseHeaders && a.getResponseHeader && 0 <= (a.getAllResponseHeaders() || "").toLowerCase().indexOf("trackjs-correlation-id") && (b.requestCorrelationId = a.getResponseHeader("trackjs-correlation-id")),
    ...
    t.prototype = {
        errorEndpoint: function (a) {
            var b = this.config.current,
                d = b.errorURL;
            this.util.testCrossdomainXhr() || -1 !== g.location.protocol.indexOf("https") ? b.forwardingDomain && (d = "https://" + b.forwardingDomain + "/capture") : (d = b.errorNoSSLURL);
            return d + "?token=" + a + "&v=3.9.2";
        },
    ...
    var c = (function () {
        function a(d, e, f, h) {
            ...
            c.forEach(e, function (e) {
                c.forEach(c.keys(e), function (c) {
                    null === e[c] || e[c] === p ? (d[c] = e[c]) : f && 10 > h && "[object Object]" === b(e[c]) ? ((d[c] = d[c] || {}), a(d[c], [e[c]], f, h + 1)) : d.hasOwnProperty(c) || (d[c] = e[c]);
                });
            });
            return d;
        }
        ...
        return {
            ...
            isWorker: "object" === typeof self && self.constructor && "DedicatedWorkerGlobalScope" === self.constructor.name,
    ...
    A.prototype = {
        ...
        writeVisitorEvent: function (a, b, d, c) {
            "password" === this.getElementType(a) && (d = p);
        ...
        getMetaValue: function (a, b) {
            return a === p ? p : { length: a.length, pattern: this.matchInputPattern(a), checked: b };
        },
            ...
            a.addEventListener
                ? a.addEventListener("unhandledrejection", function (a) {
                    try {
                        ...
                        if (e !== p && null !== e && !e.__trackjs_state__) {
                            if (!c.isError(e))
                                try {
            ...
            c.patch(a, "onerror", function (a) {
                return function (e, f, g, n, k) {
                    try {
                        ...
                        k = k || {};
                        var m = { message: k.message || b.serialize(e), name: k.name || "Error", line: k.line || parseInt(g, 10) || null, column: k.column || parseInt(n, 10) || null, stack: k.stack || null };
    ...
    C.prototype = {
        ...
        onFault: function (a) {
            ...
            a = {
                ...
                v: "3.9.2",
                h: "acbee64956609e39e975cc255a3595da016267b9",
                x: this.util.uuid(),
            };
